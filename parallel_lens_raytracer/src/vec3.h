...
__host__ __device__ inline bool operator==(const Vec3& rhs, const Vec3& lhs)
{
  return abs(rhs.x() - lhs.x()) < FLT_EPSILON && abs(rhs.y() - lhs.y()) < FLT_EPSILON
         && abs(rhs.z() - lhs.z()) < FLT_EPSILON;
}
